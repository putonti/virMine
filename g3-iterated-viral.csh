...
set awkpath = /opt/glimmer/glimmer3.02/scripts        #/home/cputonti/glimmer3.02/scripts
set glimmerpath = /opt/glimmer/glimmer3.02/bin        #/home/cputonti/glimmer3.02/bin
set elphbin = /opt/ELPH/bin/elph                           #/home/cputonti/ELPH/bin/Linux-i386/elph

# add/change glimmer options here
set glimmeropts = "-o90 -g120 -t30"
...
echo "Step 1 of ${numsteps}:  Finding orfs for training"
$glimmerpath/long-orfs -n -o 150 -g 120 -t 1.15 $genome $tag.longorfs
if  ($status != 0)  then
