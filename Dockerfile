...
RUN apt-get update && apt-get install -y curl vim csh python2.7 python2.7-dev gcc g++ unzip make git bzip2 zlib1g-dev ncurses-dev wget python-pip ipython build-essential python3-pkg-resources python-setuptools ncbi-blast+
